...
<nav>
	<ul>
		<li><a href="final_admin(2).php">Upload</a></li>
...
<form method="post" action="final_admin_upload(2).php" enctype="multipart/form-data">
	<table border="1" style="text-align: center;">
		...
		<tr>
			<td width="200px">Console Status: </td>
			<td width="400px"><select name="consoleStatus">
...
<br>
<a href="final_admin.php">Upload Game</a>
