...
$result = mysqli_query($connection,"SELECT * FROM game WHERE Name = '$name'");
...
if(isset($_POST['save'])){
	...
	$type_save = $_POST['typeTxt'];

	$edit = mysqli_query($connection, "UPDATE game SET Name ='$name_save', Price ='$price_save', Status ='$status_save', type ='$type_save' WHERE Name = '$name'");
